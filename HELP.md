...
* The original package name 'com.in28minutes.springboot.web.spring-boot-web-application' is invalid and this project uses 'com.in28minutes.springboot.web.springbootwebapplication' instead.
